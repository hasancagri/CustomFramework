...
{
    public class ProductMustBeInCondimentsCategory
        : Specification<NorthwindApp.Entities.DTO.Product>
    {
        ...
        {
            if (candidate.CategoryID != 2)
            {
                BusinessRules.BusinessExceptions.Insert(0, new BusinessException("Ürün condiment kategorisinde olmalıdır."));
                return false;
            }
            return true;
        }
